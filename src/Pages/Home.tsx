...
function Home() {
  return (
    <>
      <div className=" px-2 md:px-5 lg:px-10 xl:px-[10%] w-full h-screen flex items-end py-10 justify-end bg-[url(/src/Images/background_home.png)] bg-center bg-cover bg-no-repeat">
        <div className="bg-[#fff3e3] duration-200 md:w-[66%] capitalize py-10 md:py-15 px-5 md:px-15 flex items-start justify-center flex-col gap-7">
